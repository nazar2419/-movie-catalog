...
describe('<Header />', () => {
    it('renders the basic <Header /> with a background', () => {
        const { container, getByText, getByTestId } = render(
            <Header>
                <Header.Frame>
                    <Header.Logo src="/logo.jpg" alt="Neo-films"/>
    ...
    it('renders the full <Header> with a background', () => {
        ...
        <Header src="joker1" dontShowOnSmallViewPort>
          <Header.Frame>
            <Header.Group>
              <Header.Logo src="/images/logo.jpg" alt="Neo-films" />
            ...
            <Header.Group>
              ...
              <Header.Profile>
                <Header.Picture src="/images/nazar/png" />
                <Header.Dropdown>
                  <Header.Group>
                    <Header.Picture src="/images/nazar/png" />
                    <Header.TextLink>Nazar</Header.TextLink>
                  </Header.Group>
                  <Header.Group>
