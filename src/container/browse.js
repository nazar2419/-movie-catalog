...
import { FooterContainer } from './footter';
...
export  function BrowseContainer({ slides }) {
    ...
    return profile.displayName ? (
        ...
        <Header src="joker1" dontShowOnSmallViewPort>
            <Header.Frame>
                <Header.Group>
                    <Header.Logo to={ROUTES.HOME} src={logo} alt="Neo-films" />
                    <Header.TextLink 
            ...
            <Header.Feature>
                ...
                <Header.Text> 
                    ...
                    and the guise he projects in a futile attempt to feel like he's part 
